...
public class InfinitumMod
{
    ...
    public static final String MOD_ID = "infinitummod";
    ...
    public InfinitumMod() {
        ...
        Config.loadConfig(Config.CLIENT_CONFIG, FMLPaths.CONFIGDIR.get().resolve("infinitummod-client.toml"));
        Config.loadConfig(Config.COMMON_CONFIG, FMLPaths.CONFIGDIR.get().resolve("infinitummod-common.toml"));
    ...
    private void enqueueIMC(final InterModEnqueueEvent event)
    {
        ...
        InterModComms.sendTo("infinitummod", "helloworld", () -> { LOGGER.info("Hello world from the MDK"); return "Hello world";});
    }
